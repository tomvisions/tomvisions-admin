...
export const getImagesByGalleryId = createAsyncThunk(
    `${SLICE_NAME}/media/imagesByGalleryId`,
    async (data: GetSalesProductsRequest) => {
        const response = await apiGetImagesByGalleryId<
            GetSalesProductsResponse,
            GetSalesProductsRequest
        >(data)
...
const productListSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(getImagesByGalleryId.pending, (state) => {
                state.loading = true
            })
    },
})
